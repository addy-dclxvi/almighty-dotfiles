...
Maybe not always up to date with my current setup. <br />
...
**Now Playing** : Led Zeppelin - Since I Have Been Loving You <br />
...
**Now Playing** : Dream Theater - Strange Deja Vu <br />

## i3 : Vacant
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-i3-pywal.jpg) <br />
My current i3 setup on Debian. Vanilla i3, too lazy too build i3-gaps. I place this configuration on *~/.config/i3-pywal*.
If You want to use it, just copy every content in this folder to *~/.config/i3*. And everything is pywaled (not grammatically correct).
So, You need install pywal first. <br />
...
## Bspwm : Ant Man
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-bspwm2.jpg) <br />
My current Bspwm setup :sunglasses:. Just in case You want to see some workflow check [this](https://www.youtube.com/watch?v=2k8JoW44GdY) Video. <br />
**Stuff in the screenshot** : Lemonbar, CAVA, tty-clock, and ufetch <br />
**Now Playing** : Dream Theater - Panic Attack <br />
...
**Stuff in the screenshot** : Weechat and dunst <br />
...
**Now Playing** : Messughah - Bleed <br />
...
**Now Playing** : Antonio Vivaldi - Four Season : Winter <br />

## Herbstluftwm : Yosemite
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-herbstluftwm2.jpg) <br />
...
**Now Playing** : Rage Againts The Machine - Killing in The Name Of <br />
...
**Now Playing** : Dream Theater - The Dying Soul <br />
...
**Now Playing** : Metallica - Wherever I May Roam <br />
...
**Now Playing** : System of a Down - Lonely Day <br />
...
I recommend You to use [Mixed Fvwm Themes](http://www.vakuumverpackt.de/fvwm/) instead. <br />
**Stuff in the screenshot** : Fvwm Pager, Minimized to Thumbnail module (Firefox, GIMP, and Evince), Thunar, vim inside termite, and ncmpcpp. 
I haven't pushed this, too lazy to fix some problem. This WM really drain my patience (╯°□°）╯︵ ┻━┻ <br />
**Now Playing** : Beethoven - Moonlight Sonata <br />

## Explanations
- **Openbox (Best WM)** <br /> Some useful keybinds like snap window with useless gaps (super + arrows). MPC control using *play/pause, next, previous,* and *stop* keys. 
*Super + number* to switch workspace like in i3wm. *Super + shift + number* to send window to another workspace (also like in i3wm), and more keybinds. <br />
...
- **.profile and .xsessionrc** <br /> They are scripts those executed by LightDM when You login on X session. Previously I use *.profile* file when I'm still on Arch. 
But, I find that *~/.profile* file is not executed by LightDM on Debian.
...
- **Rofi (best launcher)** My Rofi looks like this <br />
...
And the launch configuration is in *~/.utility/rofi-apps*. If You use my *.profile* or *.xsessionrc*, just make a keybind to execute ```rofi-apps``` to make your Rofi launched with appearance like this. <br /> 
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-rofi2.jpg) <br /> 
...
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-obmenu.jpg) <br /> 
...
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-neofetch.jpg) <br /> 
When the colour accent of my theme is cyan I launch ```fetch -cyan```. <br /> 
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-neofetch2.jpg) <br /> 
...
Example : tint2 in my Openbox screenshoot preview above is using these script to display weather and now-playing. <br />
But You can also use it for Polybar custom script, Lemonbar feeder, dzen2 feeder, Conky execi, or pipe it to Dunst, just use your creativity. <br /> 
Don't forget to read the script before use.

- **Xresources** <br /> My configuration for URxvt (best terminal), including copy paste support by [Muennich](https://github.com/muennich/urxvt-perls). 
...
It makes me can change or mix the colour scheme for urxvt, dmenu, and rofi easily. You will understand if You look at it. <br />
...
- **Tint2 (Best Panel)** <br /> Just a single tint2rc, looks like my Openbox preview above. For my another Tint2 collections please check my [Tint2 Themes Collections](https://github.com/addy-dclxvi/Tint2-Theme-Collections). 
...
- **ncmpcpp (best music player)** <br /> A simple ncmpcpp config, with album art support. The album art script is taken from [Marco](https://marcocheung.wordpress.com/). Slightly modified to get rid the transparency bug. <br />
...
Urxvt with pixbuf enabled is needed. You can get it from AUR, the package name is *rxvt-unicode-pixbuf*. For Debian (best distro) user, You don't need, the URxvt in Debian repo is compiled with pixbuf by default.  <br />
...
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-skippy.jpg) <br />
My Skippy-XD configuration looks like this, nothing special.

- **Geany** <br /> Contains my configuration & colour scheme for Geany <br />
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-geany.jpg) <br />
My dark colour looks like this.
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-geany2.jpg) <br />
And my light colour looks like this.

- **Vim** <br /> Just a simple & plugin-less vimrc. Nothing special here, I'm not an IT guy :pensive:
...
- **gtk.css** <br /> Add useless space wasting paddings (who don't love terminal paddings? it looks nice) for vte-based terminal, including termite & xfce4-terminal.

- **~/.toys** <br /> Boys love toys, so I include some toys I collected from [Crunchbang Forum](https://crunchbang.org/forums/viewtopic.php?id=13645) & Stark's [Color-Scripts](https://github.com/stark/Color-Scripts). <br />
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-toys.jpg) <br />
I frequently use them for terminal colour scheme show-off. <br />
...
- My program launcher is rofi (best launcher) & dmenu2.

- My text editor is Geany and Vim.

- My notification daemon is Dunst (best notification daemon).
...
- My favourite bands is Dream Theater (best band in human history), important to recreate my setup :sunglasses:
...
Add black layer mask, select gradient tool in the toolbox then drag your mouse from top left to bottom right in the image. Reduce the opacity. <br />
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/tips-result1.jpg) <br />
Now my colourful conky looks nice in the dark side of wallpaper :blush: <br />
...
But let's go more advanced. My panel has purple accent colour, so I create new purple layer to make my wallpaper matches with my panel. I reduce the opacity to 10%. <br />
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/preview-fluxbox.jpg) <br />
Now my setup blends with the wallpaper :relaxed: <br />
...
Simply just increase the brightness and reduce the contrast. <br />
...
![alt text](https://raw.githubusercontent.com/addy-dclxvi/almighty-dotfiles/master/tips-result2) <br /> 
I already have a line shaped workspace indicator. So, I only need a static icons for workspace icons. <br />
...
## Credits
- [Omar](https://github.com/fikriomar16/dotfiles)(best ricer), [Epsi](https://github.com/epsi-rns/dotfiles), 
...
and other member of Linuxer Desktop Art (Our Local Ricing Community) for teaching me how to rice. <br />
The links above are pointed to their dotfiles repo. They have interesting stuff. I suggest You check them out :simple_smile:
